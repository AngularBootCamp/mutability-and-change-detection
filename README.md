# Angular Boot Camp example: mutability-and-change-detection
...
**[StackBlitz for mutability-and-change-detection](https://stackblitz.io/github/AngularBootCamp/mutability-and-change-detection)**

Alternatively, you can clone the repository locally to run the example:

```
git clone git@github.com:AngularBootCamp/mutability-and-change-detection.git
cd mutability-and-change-detection
npm install
npm start
```
